...
const AVSDFConstants = __webpack_require__(2);
...
AVSDFLayout.prototype.layout = function () {
    ...
    clusterGraph.getNodes().forEach(node => node.setCenter(clusterGraph.getCenterX() + clusterGraph.getRadius() * Math.cos(node.getAngle()), clusterGraph.getCenterY() + clusterGraph.getRadius() * Math.sin(node.getAngle())));
